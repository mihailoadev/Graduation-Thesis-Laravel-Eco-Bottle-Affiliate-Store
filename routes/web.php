...
Route::prefix('admin')->group(function () {
    ...
    Route::middleware(['auth:admin'])->group(function () {
        ...
        Route::get('/users', [UserManagementController::class, 'index'])->name('admin.users')->middleware('auth:admin','redirectIfModerator');

        Route::get('/user-view/{id}', [UserManagementController::class, 'view'])->name('admin.user-view');
        Route::post('/editUserProfile', [UserManagementController::class, 'editUserProfile'])->name('admin.editUserProfile');
        Route::post('/editUserPassword', [UserManagementController::class, 'editUserPassword'])->name('admin.editUserPassword');
