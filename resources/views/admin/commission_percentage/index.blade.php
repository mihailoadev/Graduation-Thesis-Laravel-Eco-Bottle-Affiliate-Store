                            ...
                            <tr class="gradeX" style="cursor: pointer;">
                                ...
                                <td class="text-center">
                                    <div class="btn-group" role="group" aria-label="Level Actions">
                                        <button type="button" class="btn btn-dark btn-sm rounded me-1" id="edit_button" data-bs-toggle="modal" data-bs-target="#editRecord" data-id="{{$level->id}}" data-parent_level="{{$level->parent_level}}" data-commission_percentage="{{$level->commission_percentage}}">
