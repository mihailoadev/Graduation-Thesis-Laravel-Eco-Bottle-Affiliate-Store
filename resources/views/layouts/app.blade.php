...
<head>
    ...
    <meta charset="utf-8" />
    <title>EcoBottle | User Dashboard</title>
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link {{ request()->route()->getName() === 'home' ? 'active' : '' }}" href="{{route('home')}}">
                                <i class="fa-solid fa-house"></i> <span data-key="t-widgets">Home</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link menu-link {{ request()->route()->getName() === 'earnings' ? 'active' : '' }}" href="{{route('earnings')}}">
                                <i class="fa-solid fa-coins"></i> <span data-key="t-widgets">Earnings</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link menu-link {{ request()->route()->getName() === 'referrals' ? 'active' : '' }}" href="{{route('referrals')}}">
                                <i class="fa-solid fa-code-fork"></i> <span data-key="t-widgets">Referrals</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link menu-link {{ request()->route()->getName() === 'orders' ? 'active' : '' }}" href="{{route('orders')}}">
                                <i class="fa-solid fa-list-check"></i> <span data-key="t-widgets">Orders</span>
                            </a>
                        </li>
                    </ul>
                </div>
